defmodule Masonree.Projection do
  ...
  @spec fill(Node.t(), rendered(), mode(), manifest()) :: Block.assigns()
  ...
  defp render_list(nodes, blocks, mode) do
    ...
    {rendered, problems} = Enum.map_reduce(nodes, [], render)
  ...
  @spec take_annotation(Node.t(), manifest()) :: html_attributes()
  ...
  @spec take_slot(rendered()) :: [Block.slot()]
