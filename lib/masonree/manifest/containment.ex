defmodule Masonree.Manifest.Containment do
  ...
  and which shapes are on offer is the author’s to publish.
  ...
  shapes the saved page may not keep. Enforcing a bound is a separate job from
  declaring one, and this struct declares.
